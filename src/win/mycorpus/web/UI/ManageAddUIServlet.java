...
/**
 * Servlet implementation class ManageAddUIServlet
 */
@WebServlet("/ManageAddUIServlet")
public class ManageAddUIServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    request.getRequestDispatcher("/jsp/manageAdd.jsp").forward(request, response);
	}
